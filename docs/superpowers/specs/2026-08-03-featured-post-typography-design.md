...
- Give the highlighted article link the homepage recommended-post link's visible-by-default underline and decorative, assistive-technology-hidden arrow.
- Preserve the full-card link target, existing font weight and color, and surrounding card presentation.
